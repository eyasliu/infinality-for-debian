...
CFLAGS   := -c -Wall -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -D_GNU_SOURCE=1 -D_GNU_SOURCE=1 -DFT_CONFIG_OPTION_SYSTEM_ZLIB -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS := -Wl,-Bsymbolic-functions -Wl,-z,relro -lm -lz
